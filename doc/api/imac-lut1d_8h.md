---
search:
    keywords: ['imac-lut1d.h', 'ImacLut1d', 'ImacLut1d', 'lut_new', 'lut_delete', 'lut_set', 'lut_applyRgb', 'lut_get', 'lut_print']
---
...
|void|[**lut\_set**](imac-lut1d_8h.md#1a5fd22ba0f57c718e25bef5d2f5d75492) (**[ImacLut1d](struct_imac_lut1d.md)** \* lut, unsigned int index, unsigned char value) <br>Set the lut data with security. |
|int|[**lut\_applyRgb**](imac-lut1d_8h.md#1a8628891c4dce5cffcf34aa7837a87dcd) (**[ImacLut1d](struct_imac_lut1d.md)** \* lut, **[ImacImg](struct_imac_img.md)** \* img) <br>Apply the lut to the all the channels of the image. |
|unsigned char|[**lut\_get**](imac-lut1d_8h.md#1ad1288e72dda052f149045c00ef4cfae2) (**[ImacLut1d](struct_imac_lut1d.md)** \* lut, unsigned int index) <br>Access the lut data with security. |
|void|[**lut\_print**](imac-lut1d_8h.md#1a1c9acec44b8ca8c0da6da659918f9086) (**[ImacLut1d](struct_imac_lut1d.md)** \* lut) <br>Print the lut on debug screen. |
...
```cpp
unsigned char imac-lut1d.h::lut_get (
    ImacLut1d * lut,
    unsigned int index
)
```
