---
search:
    keywords: ['imac-img.h', 'ImacImg', 'img_Channel', 'img_Format', 'ImacImg', 'img_new', 'img_delete', 'img_getPixelChannel', 'img_getPixelGrayscale', 'img_setToWhite', 'img_setPixelChannel', 'img_setPixelChannels']
---
...
|Type|Name|
|-----|-----|
|enum|[**img\_Channel**](imac-img_8h.md#1a415ca2e37928df0e87062550612407a1) { **red** = 0, **green** = 1, **blue** = 2, **rvb** = 3 } |
...
|unsigned char|[**img\_getPixelGrayscale**](imac-img_8h.md#1af9fb17f888ac6de641fe82c48ca9bbdb) (**[ImacImg](struct_imac_img.md)** \* img, unsigned int x, unsigned int y) <br>Get the average pixel value. |
|void|[**img\_setToWhite**](imac-img_8h.md#1a8c88589c2eb9c42d7e7916c97f0c20de) (**[ImacImg](struct_imac_img.md)** \* img) <br>Set all the pixels to white. |
|void|[**img\_setPixelChannel**](imac-img_8h.md#1ad25186e851da5eaf7ca0b89456784da2) (**[ImacImg](struct_imac_img.md)** \* img, unsigned int x, unsigned int y, int value, enum **[img\_Channel](imac-img_8h.md#1a415ca2e37928df0e87062550612407a1)** c) <br>Set the value of a color of a pixel. |
|void|[**img\_setPixelChannels**](imac-img_8h.md#1a57bc143e9c97536373429aff37c97291) (**[ImacImg](struct_imac_img.md)** \* img, unsigned int x, unsigned int y, int value) <br>Set each colors of the pixel with the value. |
...
```cpp
unsigned char imac-img.h::img_getPixelGrayscale (
    ImacImg * img,
    unsigned int x,
    unsigned int y
)
